        ...
        <section className="w-full py-12 md:py-24 lg:py-32">
          <div className="container space-y-12 px-4 md:px-6">
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12">
              <div className="flex flex-col items-center justify-center space-y-4 text-center lg:pr-12">
              ...
              <div className="flex items-center justify-center lg:justify-start lg:ml-12">
                <img src="/orang.png" alt="Descriptive Alt Text" className="rounded-xl transform scale-x-[-1]" />
              </div>
            </div>
          </div>
        </section>
