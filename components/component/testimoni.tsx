      ...
      <div className="container grid items-center justify-center gap-10 px-4 text-center md:px-6">
        ...
        <div className="grid w-full grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 xl:gap-8">
          ...
          <div className="flex flex-col items-start gap-4 rounded-lg bg-background p-6 shadow-lg transition-transform duration-300 ease-in-out hover:-translate-y-2 hover:shadow-xl">
            ...
            <blockquote className="text-lg leading-relaxed">
              "The battery life is impressive, lasting me for long-haul flights without any issues. They are comfortable
              to wear for extended periods, and I appreciate the sleek design. Worth every penny, and I'd recommend
              these headphones to anyone who values high-quality audio and peace and quiet."
            </blockquote>
          </div>
        </div>
      </div>
